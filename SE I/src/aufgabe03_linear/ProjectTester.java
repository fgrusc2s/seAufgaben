...
public class ProjectTester {
  ...
  //edit by fgrusc2s:	hier folgen eigene test cases
  
  @Test
  public void my_Test_1() {
	  assertFalse(complex_graph.isWellSorted(new String[] {"A", "B", "C", "A", "B"}));
  }
  
  @Test
  public void my_Test_2() {
	  assertFalse(complex_cycle.isWellSorted(new String[] {"A", "C", "E"}));
  }
  
  @Test
  public void my_Test_3() {
	  assertFalse(complex_graph.isWellSorted(new String[] {"A", "A", "B", "C", "D", "E", "F"}));
  }
  
  @Test
  public void my_Test_4() {
	  assertFalse(complex_graph.isWellSorted(new String[] {"A", "B", "X", "C", "D", "P"}));
  }
